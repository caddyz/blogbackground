 ...
 **/
@Configuration
public class RedisMybatisConfig implements Cache {
    private String id;
    private static Logger logger = LoggerFactory.getLogger(RedisMybatisConfig.class);
    private final ReadWriteLock lock = new ReentrantReadWriteLock(true);
    @Autowired
    private RedisTemplate<String,Object> redisTemplate;


    public RedisMybatisConfig(String id) {
        if(id == null){
